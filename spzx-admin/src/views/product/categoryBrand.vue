<template>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="品牌">
            <el-select class="m-2" placeholder="选择品牌" size="small" style="width: 100%" v-model="queryDto.brandId">
  ...
  <el-pagination v-model:current-page="pageParams.page" v-model:page-size="pageParams.limit" :page-sizes="[2, 4, 6, 8]"
...
import { UpdateCategoryBrandById, GetCategoryBrandPageList, SaveCategoryBrand, DeleteCategoryBrandById } from '@/api/categoryBrand.js'
