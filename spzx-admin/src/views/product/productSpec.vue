<template>
  ...
  <el-table :data="list" style="width: 100%">
    ...
    <el-table-column label="规格值" #default="scope">
      <div v-for="(item1, index1) in scope.row.specValue" :key="index1" style="padding: 5px; margin: 0;width: 100%;">
        {{ item1.key }}：
  ...
  <el-pagination v-model:current-page="pageParams.page" v-model:page-size="pageParams.limit"
    :page-sizes="[2, 4, 6, 8]" layout="total, sizes, prev, pager, next" :total="total"
